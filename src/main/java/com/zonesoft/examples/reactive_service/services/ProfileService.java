...
import com.zonesoft.examples.reactive_service.repositories.ProfileRepository;
...
public class ProfileService {
    ...
    public Mono<Profile> delete(String id) {
        return this.profileRepository
            ...
            .doOnSuccess(profile -> this.publisher.publishEvent(new ProfileDeletedEvent(profile)));
    }
